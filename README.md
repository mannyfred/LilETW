...
- Supports configuring StackTracing and EventID based filtering where applicable
...
### Microsoft-Windows-RPC Provider, RpcClientCallStart_V1 Event with StackTraces and EventID based filtering
...
Output (add whatever symbol resolving you want yourself):
```
...
---
PID: 3904 - InterfaceUuid: {367ABB81-9844-35F1-AD32-98F038001003} - ImpersonationLevel: 3 - AuthenticationLevel: 6
0x00007FF891F02887
0x00007FF891E25151
0x00007FF891A40857
0x00007FF891A6BAC4
